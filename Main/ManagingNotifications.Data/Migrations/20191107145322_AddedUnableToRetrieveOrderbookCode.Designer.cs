...
namespace DMT.ManagingNotifications.Data.Migrations
{
    ...
    [Migration("20191107145322_AddedUnableToRetrieveOrderbookCode")]
    partial class AddedUnableToRetrieveOrderbookCode
    {
            ...
            modelBuilder.Entity("DMT.ManagingNotifications.Domain.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Errors occurred during generating of orderbook(s)",
                            NotificationState = 3
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Description = "Orderbook(s) generation terminated.  Planned and overdues table empty or could not be validated/accessed",
                            NotificationState = 3
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Description = "Orderbook generated",
                            NotificationState = 1
                        },
                        new
                        {
                            Id = new Guid("4d623d87-0afd-44fd-9b5a-be2d164f891e"),
                            Description = "Orderbook weeks can not be retrieved, unable to query for generated orderbooks",
                            NotificationState = 3
                        },
                        new
                        {
                            Id = new Guid("7d625937-1cc2-4dc5-a3ce-2223b3444e18"),
                            Description = "Orderbook previews can not be retrieved, none exist or database error",
                            NotificationState = 3
                        },
                        new
                        {
                            Id = new Guid("c4faf266-389c-45a5-9b5a-3fe6fc18562e"),
                            Description = "Orderbook can not be retrieved, none exist or database error",
                            NotificationState = 3
                        });
                });
