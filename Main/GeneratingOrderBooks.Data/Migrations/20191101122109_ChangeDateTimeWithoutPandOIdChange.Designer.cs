...
namespace DMT.GeneratingOrderbooks.Data.Migrations
{
    ...
    [Migration("20191101122109_ChangeDateTimeWithoutPandOIdChange")]
    partial class ChangeDateTimeWithoutPandOIdChange
    {
                    ...
                    b.OwnsOne("DMT.GeneratingOrderBooks.Domain.ValueObjects.Order_VO", "Details", b1 =>
                        {
                            ...
                            b1.HasOne("DMT.GeneratingOrderBooks.Domain.Entities.Order")
                                .WithOne("Details")
                                .HasForeignKey("DMT.GeneratingOrderBooks.Domain.ValueObjects.Order_VO", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                    ...
                    b.OwnsOne("DMT.GeneratingOrderBooks.Domain.ValueObjects.Part_VO", "Part", b1 =>
                        {
                            ...
                            b1.HasOne("DMT.GeneratingOrderBooks.Domain.Entities.Order")
                                .WithOne("Part")
                                .HasForeignKey("DMT.GeneratingOrderBooks.Domain.ValueObjects.Part_VO", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
